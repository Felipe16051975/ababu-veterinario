            ...
            <div class="card">
                ...
                <div class="clinical-header">
                    ...
                    <div class="pet-details">
                        ...
                        {{ __('translate.days') }}
                                            <div class="col-md-3">
                                                <label>{{ __('translate.weight') }}</label>
                                                <div class="detail-value">
                                                    <span id="current-weight">{{ isset($pet->weight) ? $pet->weight . ' kg' : 'N/A' }}</span>
                                                </div>
                                            </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="pet-avatar">
                                            <img src="{{ isset($pet->avatar) && $pet->avatar ? $pet->avatar : url('/images/no-image-available.svg') }}" 
                                    ...
                                    <div class="col-md-10">
                                        <div class="row pet-details-grid">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="detail-value">{{ isset($pet->breed) ? $pet->breed : 'Mestizo' }}</div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="detail-value">{{ isset($pet->reproductive_status) ? $pet->reproductive_status : 'Esterilizado' }}</div>
                                            </div>
                                            <div class="col-md-3">
                                                <label>{{ __('translate.age') }}</label>
                                                <div class="detail-value">{{ $pet->age->years ?? '0' }} años</div>
                                            </div>
                                            <div class="col-md-3">
                                                <label>{{ __('translate.color') }}</label>
                                                <div class="detail-value">{{ isset($pet->color) ? $pet->color : 'Sin indicar' }}</div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="detail-value">
                                                    <input type="text" class="form-control form-control-sm" 
                                                           ...
                                                           value="{{ isset($pet->microchip) ? $pet->microchip : '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
